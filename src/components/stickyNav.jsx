...
export default function Navbar() {
    ...
    let activeButton =
        'button xs:text-xs sm:text-sm md:text-sm lg:text-xl font-semibold xs:h-6 md:h-8 md:w-20 lg:h-12 lg:w-32 rounded-full'
    let inactiveButton =
        'border xs:text-xs sm:text-sm md:text-sm lg:text-xl font-semibold xs:h-6 md:h-8 md:w-20 lg:h-12 lg:w-32 rounded-full'
    ...
    return (
        ...
        >
            ...
            <div className="flex xs:w-48 md:w-64 lg:w-1/4 justify-between items-center ml-auto mr-2">
                <ScrollLink
                    to="projects"
                    smooth={true}
                    duration={500}
