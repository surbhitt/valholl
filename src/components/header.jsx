          ...
          <nav className="flex flex-col border-2 border-purple-950 items-center">
            ...
            <div className="flex justify-evenly items-center">
              <div className="card-container flex justify-evenly items-center">
                <button 
                    className="card flex font-semibold xs:h-8 sm:h-10 md:h-12 h-20 text-white xs:text-md sm:text-lg lg:text-xl xl:text-2xl items-center justify-center rounded-2xl"
